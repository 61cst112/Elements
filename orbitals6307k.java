...
class Element {
  ...
  void electrons() {
    ...
    //
    for ( int i=1; i<z+1; i++ ) {
      if (i<=2) { ring=1; pop=2; r=250; g=0; b=250; }               // K
      else if (i<=10) { ring=2; pop=8; r=250; g=0; b=0; }           // L
      else if (i<=18) { ring=3; pop=8; r=200; g=200; b=0; }         // M
      else if (i<=28) { ring=3; pop=18; r=200; g=200; b=0; }         // M
      else if (i<=60) { ring=4; pop=32; r=0; g=200; b=0; }           // M
      else if (i<=110) { ring=5; pop=50; r=0; g=0; b=200; }          // N
      else { ring=6; pop=72; r=0; g=200; b=200;  }           // O
      //--  int pop=  2 * ring*ring;
      radius=  z/3 + 60 * ring;
